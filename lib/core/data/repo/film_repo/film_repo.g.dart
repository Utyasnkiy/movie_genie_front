...
class _FilmRepo implements FilmRepo {
  _FilmRepo(
    this._dio, {
    this.baseUrl,
  });
  ...
  @override
  Future<void> updateCover(UpdateFilmCover updateFilmCover) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = updateFilmCover;
    await _dio.fetch<void>(_setStreamType<void>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
  ...
  @override
  Future<Film> get(int id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result =
        await _dio.fetch<Map<String, dynamic>>(_setStreamType<Film>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = Film.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<List<Film>> getWatchLater() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<void> addToWatchLater(int id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<void> removeFromWatchLater(int id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
